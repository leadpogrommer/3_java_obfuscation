-injars  build/libs/server_full.jar
-outjars build/libs/server_pg.jar
-keep class ru.leadpogrommer.sb.server.MainKt
-keepclassmembers class ru.leadpogrommer.sb.server.MainKt { *; }
